        ...
        public static void Migrate()
        {
            ...
            foreach (string scene in scenes)
            {
                ...
                foreach (var emitter in emitters)
                {
                    ...
                    newEmitter.PlayEvent = startOnAwake ? EmitterGameEvent.Created : EmitterGameEvent.None;
                    newEmitter.PlayEvent = startOnAwake ? EmitterGameEvent.Destroy : EmitterGameEvent.None;
                }
