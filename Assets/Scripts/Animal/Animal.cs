...
public class Animal : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            m_tCollider.eulerAngles = new Vector3(m_gqGrounder.PelvisRotation.x + m_v3PelvisOffset.x, m_tJointRoot.rotation.eulerAngles.y + m_v3PelvisOffset.y, m_v3PelvisOffset.z);
        }
