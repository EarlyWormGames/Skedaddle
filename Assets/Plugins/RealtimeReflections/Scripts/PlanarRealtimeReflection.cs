...
namespace RealtimeReflection
{
    ...
    public class PlanarRealtimeReflection : MonoBehaviour
    {
        ...
        public float m_RenderDistance = 50;

        public string m_MaterialProperty;
        [HideInInspector]
        public Material m_MatInstance;
        ...
        public void OnWillRenderObject()
        {
            ...
            //Adjust camera clipping plane
            float renderDist = cam.farClipPlane;
            cam.farClipPlane = m_RenderDistance;
            ...
            m_MatInstance.SetTexture(m_MaterialProperty, m_ReflectionTexture);
            ...
            m_MatInstance.SetMatrix("_ProjMatrix", mtx);
            ...
            //Restore old camera clip plane
            cam.farClipPlane = renderDist;
        }
