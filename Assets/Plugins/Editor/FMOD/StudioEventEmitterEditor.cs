...
namespace FMODUnity
{
    ...
    class StudioEventEmitterEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            var vol = serializedObject.FindProperty("PlayVolume");
            var grp = serializedObject.FindProperty("Group");
            ...
            EditorGUILayout.PropertyField(vol, new GUIContent("Play Volume"));
            EditorGUILayout.PropertyField(grp, new GUIContent("Group"));
